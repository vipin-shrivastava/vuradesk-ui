    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-gray-100 dark:bg-background-main">
      ...
      >
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl font-bold mb-4">Join {settings.appName}</h1>
          <p className="mt-2 text-lg text-slate-200">
            Create an account to start submitting tickets.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-8 lg:p-16">
        <div className="bg-white dark:bg-card-bg p-10 rounded-2xl shadow-lg w-full max-w-md">
          <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-text-main">Create an Account</h2>
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="firstName" className="block text-gray-700 dark:text-text-muted text-sm font-semibold mb-2">First Name</label>
              ...
              <div>
                <label htmlFor="lastName" className="block text-gray-700 dark:text-text-muted text-sm font-semibold mb-2">Last Name</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
                  <input
                    type="text"
